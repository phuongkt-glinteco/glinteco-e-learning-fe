...
async function bootstrap() {
  ...
  try {
    ...
    `);
    // Ensure any mistakenly baselined entry for AddLastClaimedXpAtToUsers or UpdateTracksAndLessonsSchema is removed
    await dataSource.query(`DELETE FROM "migrations" WHERE name IN ('AddLastClaimedXpAtToUsers1784301323000', 'UpdateTracksAndLessonsSchema1784400000000');`);
