...
* **Tổng số Unit Test Suites:** 24/24 passed (100%)
* **Tổng số Unit Tests:** 216/216 passed (100%)
...
| :--- | :---: | :---: | :---: | :---: | :--- |
| **All files** | **95.43** | **76.01** | **92.65** | **95.65** | |
| **src** | **100** | **75** | **100** | **100** | |
...
| **src/modules/users** | **100** | **83.33** | **100** | **100** | |
| ├─ `users.controller.ts` | 100 | 83.33 | 100 | 100 | 39-45 |
| └─ `users.service.ts` | 100 | 83.33 | 100 | 100 | 22-30 |
...
| ├─ `tracks.controller.ts` | 100 | 75 | 100 | 100 | 40-69 |
...
* API Đăng ký (Registration API): ~`225ms`
* API Đăng nhập (Login API): ~`131ms`
* API Lấy thông tin cá nhân (Profile Retrieval `/me` API): ~`7ms`
