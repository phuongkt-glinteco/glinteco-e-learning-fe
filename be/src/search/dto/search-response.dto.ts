...
export class SearchExerciseResultDto {
  ...
  @ApiProperty({
    example: 'NestJS',
    description: 'Tên của Track chứa bài tập này',
  })
  tag: string;
}
...
export class SearchResponseDto {
  @ApiProperty({
    type: [SearchTrackResultDto],
    description: 'Danh sách Tracks tìm thấy',
  })
  tracks: SearchTrackResultDto[];

  @ApiProperty({
    type: [SearchDocumentResultDto],
    description: 'Danh sách Documents tìm thấy',
  })
  documents: SearchDocumentResultDto[];

  @ApiProperty({
    type: [SearchExerciseResultDto],
    description: 'Danh sách Exercises tìm thấy',
  })
