...
export class ReorderTracksDto {
  @ApiProperty({
    description: 'Danh sách ID (UUID) của các tracks được sắp xếp lại theo thứ tự mới.',
    type: [String],
    example: [
  ...
  @IsUUID('4', { each: true, message: 'Mỗi phần tử trong order phải là một UUID hợp lệ' })
