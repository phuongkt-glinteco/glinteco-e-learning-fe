...
- [ ] Toàn bộ các ca kiểm thử tự động (Unit Test và E2E Test tại [be/test](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test)) chạy thành công (100% Pass).
- [ ] Đạt chỉ tiêu độ bao phủ mã nguồn (Code Coverage) tối thiểu theo yêu cầu dự án và báo cáo độ bao phủ tại [test_coverage.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/test_coverage.md) đã được cập nhật.
...
## 6. Liên kết Tài liệu Kỹ thuật & Kiểm thử Backend (Backend Technical & Testing Documentation)

Để phục vụ phát triển (Dev) và kiểm thử chất lượng (QC), các đặc tả kỹ thuật và kết quả test của Backend được tổ chức cụ thể như sau:

### 6.1 Tài liệu Đặc tả Phân hệ & Độ bao phủ (`be/docs`)
Xem chi tiết tại thư mục [be/docs](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs):
* **[test_coverage.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/test_coverage.md):** Báo cáo độ bao phủ kiểm thử tổng quát của NestJS backend (Unit tests và E2E tests).
* **[auth.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/auth.md):** Đặc tả phân hệ Xác thực (Google Login, JWT, Refresh Token) và kịch bản unit test tương ứng.
* **[cohorts.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/cohorts.md):** Đặc tả phân hệ Lớp học và các ca kiểm thử cho Admin.
* **[submissions.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/submissions.md):** Đặc tả nghiệp vụ quản lý bài nộp, tích hợp Slack webhook, email và unit test tương ứng.
* **[roles.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/roles.md):** Đặc tả ma trận phân quyền (RBAC) và kiểm thử bảo mật `RolesGuard`.
* **[api_usage_guide.md](file:///home/phamhung/Work/glinteco-e-learning-fe/be/docs/api_usage_guide.md):** Hướng dẫn sử dụng API, cURL và danh sách tài khoản kiểm thử mặc định.

### 6.2 Kiểm thử End-to-End & Hiệu năng (`be/test`)
Toàn bộ kịch bản kiểm thử tích hợp và kiểm thử hiệu năng API nằm ở thư mục [be/test](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test):
* **[auth.e2e-spec.ts](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test/auth.e2e-spec.ts):** Kiểm thử tích hợp toàn bộ luồng đăng nhập, lấy token và refresh token.
* **[users.e2e-spec.ts](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test/users.e2e-spec.ts):** Kiểm thử tích hợp thông tin người dùng và cập nhật profile.
* **[auth-perf.e2e-spec.ts](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test/auth-perf.e2e-spec.ts):** Kiểm thử hiệu năng (Response time) của các API Xác thực cốt lõi.
* **[app.e2e-spec.ts](file:///home/phamhung/Work/glinteco-e-learning-fe/be/test/app.e2e-spec.ts):** Kiểm thử cơ bản ứng dụng khởi chạy thành công.
